...
<head>
    ...
    <style>
        ...
        .media-type.filme { background-color: darkgreen; }
        .media-type.serie { background-color: darkred; }
        ...
        .release-year.filme { background-color: Navy; }
        .release-year.serie { background-color: DarkMagenta; }
